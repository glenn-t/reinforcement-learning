...
# Conclusions:
  ...
  * There is a challenge of measuring performance. How do you make it objective and not dependant on the parameters of the opponent? Furthermore, if it does well against a bad opponent, what is that worth?
